...
def add_heading_styled(doc, text, level):
    # Step 1: Set Heading level (Heading 1, Heading 2, Heading 3)
...
def add_caption_styled(doc, label_text, seq_name, title_text):
    ...
    set_run_fonts(r_lbl, font_size=Pt(10), bold=True, color_rgb=RGBColor(12, 35, 64))
    ...
    set_run_fonts(r_title, font_size=Pt(10), bold=True, color_rgb=RGBColor(12, 35, 64))
    return p
...
def build_exact_steps_word_docx():
    ...
    # Step 1: Configure Built-in Heading 1, Heading 2, Heading 3 & Normal Styles
    ...
    set_style_font_and_color(doc, 'Caption', Pt(10), bold=True, color_rgb=RGBColor(12, 35, 64))
    ...
    # ----------------------------------------------------
    # STEP 2: INSERT AUTOMATIC TABLE OF CONTENTS (Table of Contents) AT FRONT
    # ----------------------------------------------------
    ...
    print(f"Successfully generated Word proposal document following Step 1 Heading levels & Step 2 Front Auto-TOC at:\n - {out_local}\n - {out_desktop}")

if __name__ == '__main__':
    build_exact_steps_word_docx()
