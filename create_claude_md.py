...
local_claude_path = r'c:\Users\administartor\Downloads\AIEC\claude.md'
with open(local_claude_path, 'w', encoding='utf-8') as f:
    f.write(__doc__)

# Save to Obsidian vault
obsidian_claude_path = r'G:\我的雲端硬碟\secondbrain\AIEC\claude.md'
with open(obsidian_claude_path, 'w', encoding='utf-8') as f:
    f.write(__doc__)

print(f"Successfully generated {local_claude_path}")
print(f"Successfully generated {obsidian_claude_path}")
