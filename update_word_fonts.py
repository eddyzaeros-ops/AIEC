...
def set_style_fonts(doc, font_name_en=FONT_EN, font_name_zh=FONT_ZH):
    styles = doc.styles
    for style_name in ['Normal', 'Heading 1', 'Heading 2', 'Heading 3', 'Table Grid', 'Header', 'Footer']:
...
def build_reformatted_docx():
    ...
    for title_text, page_num in toc_items:
        ...
        set_run_fonts(r_t, font_size=Pt(10), color_rgb=RGBColor(12, 35, 64))
    ...
    print(f"Successfully generated reformatted Word proposal document with SimHei & Arial at:\n - {out_local}\n - {out_desktop}")

if __name__ == '__main__':
    build_reformatted_docx()
