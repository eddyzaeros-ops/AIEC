...
def add_heading_styled(doc, text, level):
    ...
    if level == 1:
        run.font.size = Pt(20)
        run.font.color.rgb = RGBColor(12, 35, 64) # Navy
    elif level == 2:
...
def add_body_p(doc, text, bold_prefix="", space_after=6):
    ...
    if bold_prefix:
        ...
        r_b.bold = True
        r_b.font.size = Pt(11)
        r_b.font.color.rgb = RGBColor(12, 35, 64)
...
def generate_master_docx_proposal():
    # Ensure fresh 300 DPI high-res infographics
    ...
    r_title.bold = True
    r_title.font.color.rgb = RGBColor(12, 35, 64)
    ...
    for idx, (k, v) in enumerate(meta_data):
        ...
        r1.font.color.rgb = RGBColor(12, 35, 64)
    ...
    for title_text, page_num in toc_items:
        ...
        r_t.font.name = "微軟正黑體"
        r_t.font.size = Pt(10)
        r_t.font.color.rgb = RGBColor(12, 35, 64)
    ...
    for title_text, page_num in tbl_items:
        ...
        r_tb = p_tb.add_run(title_text)
        r_tb.font.name = "微軟正黑體"
        r_tb.font.size = Pt(10)
        r_tb.font.color.rgb = RGBColor(30, 58, 138)
    ...
    r_t1.font.name = "微軟正黑體"
    r_t1.bold = True
    r_t1.font.size = Pt(10.5)
    r_t1.font.color.rgb = RGBColor(12, 35, 64)
    ...
    r_t21.font.name = "微軟正黑體"
    r_t21.bold = True
    r_t21.font.size = Pt(10.5)
    r_t21.font.color.rgb = RGBColor(12, 35, 64)
    ...
    r_t22.font.name = "微軟正黑體"
    r_t22.bold = True
    r_t22.font.size = Pt(10.5)
    r_t22.font.color.rgb = RGBColor(12, 35, 64)
    ...
    r_cap21.font.name = "微軟正黑體"
    r_cap21.bold = True
    r_cap21.font.size = Pt(9.5)
    r_cap21.font.color.rgb = RGBColor(37, 99, 235)
    ...
    r_t23.font.name = "微軟正黑體"
    r_t23.bold = True
    r_t23.font.size = Pt(10.5)
    r_t23.font.color.rgb = RGBColor(12, 35, 64)
    ...
    r_cap22.font.name = "微軟正黑體"
    r_cap22.bold = True
    r_cap22.font.size = Pt(9.5)
    r_cap22.font.color.rgb = RGBColor(37, 99, 235)
    ...
    r_cap23.font.name = "微軟正黑體"
    r_cap23.bold = True
    r_cap23.font.size = Pt(9.5)
    r_cap23.font.color.rgb = RGBColor(37, 99, 235)
    ...
    r_t31.font.name = "微軟正黑體"
    r_t31.bold = True
    r_t31.font.size = Pt(10.5)
    r_t31.font.color.rgb = RGBColor(12, 35, 64)
    ...
    r_t41.font.name = "微軟正黑體"
    r_t41.bold = True
    r_t41.font.size = Pt(10.5)
    r_t41.font.color.rgb = RGBColor(12, 35, 64)
    ...
    r_t42.font.name = "微軟正黑體"
    r_t42.bold = True
    r_t42.font.size = Pt(10.5)
    r_t42.font.color.rgb = RGBColor(12, 35, 64)
    ...
    print(f"Successfully generated proposal document at:\n - {out_local}\n - {out_desktop}")

if __name__ == '__main__':
    generate_master_docx_proposal()
