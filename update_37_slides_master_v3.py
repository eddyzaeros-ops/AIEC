...
def generate_37_slides_master_deck():
    # Build v2 high-res pure white background infographics with Traditional Chinese
    ...
    # ----------------------------------------------------
    # Infographic Slide 1: Slide 35 (Pure White BG + Traditional Chinese Infographic PNG)
    # ----------------------------------------------------
    ...
    s35.shapes.add_picture(os.path.join('infographics', 'info_pipeline_s35.png'), Inches(0.8), Inches(1.5), width=Inches(14.4))
    add_acronym_footer(s35, ["AIEC", "RoE", "TRL", "CMMC", "SOP"], y_pos=7.60, height=1.0)

    # ----------------------------------------------------
    # Infographic Slide 2: Slide 36 (Pure White BG + Traditional Chinese Infographic PNG)
    # ----------------------------------------------------
    ...
    s36.shapes.add_picture(os.path.join('infographics', 'info_3d_matrix_s36.png'), Inches(0.8), Inches(1.5), width=Inches(14.4))
    add_acronym_footer(s36, ["ATLAS", "GPS", "SPIFFE", "OPA", "LoRA", "GGUF", "ECE", "COA"], y_pos=7.60, height=1.0)

    # ----------------------------------------------------
    # Infographic Slide 3: Slide 37 (Pure White BG + Traditional Chinese Infographic PNG)
    # ----------------------------------------------------
    ...
    s37.shapes.add_picture(os.path.join('infographics', 'info_4tier_compute_s37.png'), Inches(0.8), Inches(1.5), width=Inches(14.4))
