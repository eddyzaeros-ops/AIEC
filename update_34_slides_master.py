...
def generate_34_slides_master_deck():
    prs = Presentation()
    ...
    # ----------------------------------------------------
    # Slide 2: TABLE OF CONTENTS (Update Slide 2 for P.30 - 34)
    # ----------------------------------------------------
    ...
    c2_bullets = [
        ...
        "6. **第六區塊：國防 AI 安全進階防禦與主權架構 (P.30 - 34)**",
        "   - P.30 NCSIST 藍圖 | P.31 RoE 邊界 | P.32 邊緣自毀 (<100ms)",
        "   - P.33 地端模型蒸餾 | P.34 結論與未來展望 (MAITE & LVC 藍圖)"
    ]
    ...
    # ----------------------------------------------------
    # SECTION 6: Slides 30-34 - Advanced Defense AI Security & Infrastructure
    # ----------------------------------------------------
    ...
    # ----------------------------------------------------
    # Slide 34: CONCLUSION & FUTURE ROADMAP (NEW SLIDE!)
    # ----------------------------------------------------
    ...
    prs.save(out_path)
    print(f'Successfully generated master 34-slide presentation at: {out_path}')

if __name__ == '__main__':
    generate_34_slides_master_deck()
