...
def build_metric_single_slide(prs, blank_layout, metric_data, acronym_keys):
    ...
    # Render LaTeX images
    calc_img = render_latex_to_png(metric_data['latex_calc'], f"calc_q{metric_data['id']}.png")
    ...
    # Embed Calc Formula Image
    s.shapes.add_picture(calc_img, Inches(1.3), Inches(3.8), width=Inches(6.0))

    tb_l_bot = s.shapes.add_textbox(Inches(1.1), Inches(4.7), Inches(6.4), Inches(3.0))
    left_bullets_bot = [
    ...
    s.shapes.add_picture(thresh_img, Inches(8.7), Inches(4.5), width=Inches(6.0))

    tb_r_bot = s.shapes.add_textbox(Inches(8.5), Inches(5.4), Inches(6.4), Inches(2.3))
    right_bullets_bot = [
