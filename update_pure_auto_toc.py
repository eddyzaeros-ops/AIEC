...
def add_pure_native_auto_toc(doc, instruction='TOC \\o "1-3" \\h \\z \\u'):
    # Pure Word Native Auto-TOC element (w:sdt Component) without any manual text lines
    sdt_xml = f'''
    <w:sdt {nsdecls("w")}>
      <w:sdtPr>
        <w:docPartObj>
...
def build_pure_auto_toc_docx():
    ...
    # ----------------------------------------------------
    # PURE AUTOMATIC TABLE OF CONTENTS (100% Word Auto-Generated, No manual dots)
    # ----------------------------------------------------
    ...
    # ----------------------------------------------------
    # PURE AUTOMATIC LIST OF FIGURES (圖目錄 - Word 自動生成)
    # ----------------------------------------------------
    ...
    # ----------------------------------------------------
    # PURE AUTOMATIC LIST OF TABLES (表目錄 - Word 自動生成)
    # ----------------------------------------------------
    ...
    print(f"Successfully generated Word proposal document with 100% pure Word Auto-TOC fields at:\n - {out_local}\n - {out_desktop}")

if __name__ == '__main__':
    build_pure_auto_toc_docx()
